...
| 范围 | 环境 | 日期 | 结果 |
| --- | --- | --- | --- |
| iPhone 完整测试 | iPhone 17 Pro / iOS 26.5 Simulator | 2026-09-10 | 392 通过，0 失败，0 跳过；含 13 项 UI 测试 |
| Watch 完整测试 | Apple Watch Series 11 46mm / watchOS 26.5 Simulator | 2026-09-10 | 31 通过，0 失败，0 跳过 |
| Release 构建 | generic iOS Simulator；全新 DerivedData | 2026-09-10 | 成功；主 App/Watch 均为 1.3（3），dSYM UUID 对应 |
| Release 边界 | App/Watch 二进制及 App 包 | 2026-09-10 | 三个 DEBUG 入口均不在产物中；Privacy Manifest 存在，Tracking=false，无后台生成模式 |
...
- 13 项 UI 回归包括 4 项任务操作/最大字号、5 项片段确认、4 项真实时间轴拖动。
